...
var octocatWave = (0, _styledComponents.keyframes)(["0%,100%{transform:rotate(0);}20%,60%{transform:rotate(-25deg);}40%,80%{transform:rotate(10deg);}"]);
...
})(["z-index:99;fill:", ";color:", ";position:absolute;top:0;border:0;right:0;"], (0, _theme.get)('colors.primary'), (0, _theme.get)('colors.background'));
