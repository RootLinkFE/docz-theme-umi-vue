...
})(["position:absolute;display:inline-block;top:7px;left:-22px;opacity:0;transition:opacity 0.2s;color:", ";"], (0, _theme.get)('colors.primary'));

var Heading = _styledComponents.default.h3.withConfig({
  displayName: "H3__Heading"
})(["position:relative;&:hover .heading--Icon{opacity:1;}", ";"], (0, _theme.get)('styles.h3'));

var H3 = function H3(_a) {
