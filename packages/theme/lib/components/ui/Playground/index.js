...
var _ActionsBar = require("./ActionsBar");
...
var Pre = (0, _styledComponents.default)(_Editor.Editor).withConfig({
...
var Playground = function Playground(_ref) {
  var position = _ref.position,
      ...
      CustomWrapper = _ref$wrapper === void 0 ? React.Fragment : _ref$wrapper;
  ...
  var _useState3 = (0, React.useState)(initialCode),
  ...
  var codesandboxUrl = (0, React.useCallback)(function (native) {
  ...
  return /*#__PURE__*/React.createElement(_reactLive.LiveProvider, {
    code: code,
    scope: scope,
    ...
    full: fullscreen
  }, /*#__PURE__*/React.createElement(StyledPreviewWrapper, null, /*#__PURE__*/React.createElement(CustomWrapper, null, /*#__PURE__*/React.createElement(_reactLive.LivePreview, {
    className: className,
    style: style
  ...
  }), showEditor && /*#__PURE__*/React.createElement(Pre, _extends({}, editorProps, {
    onChange: setCode,
    readOnly: false
  }), code)))));
};
