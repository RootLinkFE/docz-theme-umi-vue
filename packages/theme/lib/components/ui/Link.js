...
exports.Link = exports.LinkStyled = void 0;
...
var LinkStyled = _styledComponents.default.a.withConfig({
  displayName: "Link__LinkStyled"
})(["&,&:visited,&:active{text-decoration:none;color:", ";}&:hover{color:", ";}", ";"], (0, _theme.get)('colors.link'), (0, _theme.get)('colors.link'), (0, _theme.get)('styles.link'));
...
var Link = function Link(_a) {
  ...
  var docs = (0, _docz.useDocs)();
  var toCheck = (0, React.useMemo)(function () {
  ...
  return isInternal ? /*#__PURE__*/React.createElement(LinkStyled, _extends({
    as: Link
  }, props, {
    to: nHref
  })) : /*#__PURE__*/React.createElement(LinkStyled, _extends({}, props, {
    href: nHref
  }));
};
